            ...
            if user.email is not None:
                ...
                if serializer.is_valid():
                    with transaction.atomic():
                        ...
                        mail_subject = (
                            "Renouvellement du mot de passe - E.B.H Gestion Magasin"
                        )
...
class UsersListCreateView(APIView):
    ...
    def get(request, *args, **kwargs):
        ...
        queryset = (
            ...
            .prefetch_related("store_memberships__store", "store_memberships__role")
        )
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            mail_subject = "Invitation - Application de E.B.H Gestion Magasin"
    ...
    def get(self, request, *args, **kwargs):
        ...
        user = (
            CustomUser.objects.prefetch_related(
                "store_memberships__store", "store_memberships__role"
            )
            .filter(pk=pk)
            .first()
        )

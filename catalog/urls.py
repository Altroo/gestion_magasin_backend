...
urlpatterns = [
    path(
        "categories/", CategoryListCreateView.as_view(), name="categories-list-create"
    ),
    path(
        "categories/<int:pk>/",
        CategoryDetailEditDeleteView.as_view(),
        name="categories-detail",
    ),
    path("units/", ProductUnitListCreateView.as_view(), name="units-list-create"),
    path(
        "units/<int:pk>/",
        ProductUnitDetailEditDeleteView.as_view(),
        name="units-detail",
    ),
    ...
    path(
        ...
        ProductImportWorkbookView.as_view(),
        name="products-import-workbook",
    ),
    path(
        "products/send-csv-example-email/",
        SendCSVExampleEmailView.as_view(),
        name="products-send-csv-example-email",
    ),
    path(
    ...
    path(
        "products/<int:pk>/",
        ProductDetailEditDeleteView.as_view(),

"""Django settings for the gestion_magasin project."""
...
ROOT_URLCONF = "gestion_magasin_backend.urls"
...
CORS_ALLOWED_ORIGINS = config(
    "CORS_ALLOWED_ORIGINS", default="http://localhost:3006"
).split(",")
CORS_ALLOW_CREDENTIALS = True

ASGI_APPLICATION = "gestion_magasin_backend.asgi.application"
WSGI_APPLICATION = "gestion_magasin_backend.wsgi.application"
...
REST_AUTH = {
    ...
    "JWT_AUTH_COOKIE": "gestion_magasin-jwt-access",
    "JWT_AUTH_REFRESH_COOKIE": "gestion_magasin-jwt-refresh",
    "TOKEN_MODEL": None,
